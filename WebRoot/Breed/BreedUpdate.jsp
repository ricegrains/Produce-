						...
						<tr>
							<td bgcolor="#e3f1fe" valign="middle" align="center" width="100%">
								<fieldset style="width: 90%;">
									<legend>养殖信息 </legend>
									<form action="BreedUpdateServlet" method="post" name="form1">
									<table border="1" width="90%" align="center">
										<tr>
											<td align="right"> 池塘编号： </td>
											<td align="left">
												<input type="hidden" name="pondid" value="${List.pondid}" />
											</td>
											<td align="right"> 地块编号： </td>
											<td align="left">
												<my:breed table="ContractSignPlots" id="ContractSignPlotsID"/>
											</td>
										</tr>
										<tr>
											<td align="right"> 水域特征： </td>
											<td align="left">
												<textarea style="background-color: #e8f2fe;" rows="2" cols="24" name="watercharacterize">${List.watercharacterize}</textarea>
											</td>
