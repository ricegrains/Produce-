...
<html>
	...
	<body bgcolor="#dfe8f4">
		<div style="font-family: inherit">
			...
			<a href=PutFry.jsp style="margin-top: 20; margin-left: 38; text-decoration: none;color: #e37c7b; font-size: 30px;">返回上一页</a>
		</div>
		
		<form action="PutFryUpdateServlet" method="post" name="form1">
						...
						<fieldset style="width: 100%;">
							...
							<table border="0" width="100%">
								...
								<tr align="center">
									...
									<td align="left">
										<input type="text" size="25" name="fishingdate" value="${List.fishingdate }">
									</td>
								...
								<tr align="center">
									...
									<td align="left">
										<input type="text" size="25" name="putfrydate" value="${List.putfrydate }">
									</td>
									<td align="right">投放数量：</td>
									<td align="left">
										<input type="text" size="25" name="quantity" value="${List.quantity }">
									</td>
								...
								<tr align="center">
									...
									<td align="left">
										<input type="text" size="25" name="type" value="${List.type }">
									</td>
									<td align="right">重量：</td>
									<td align="left">
										<input type="text" size="25" name="weight" value="${List.weight }">
									</td>
								</tr>
								<tr align="center">	
									<td align="right">种苗来源：</td>
									<td align="left">
										<input type="text" size="25" name="comefrom" value="${List.comefro }">
									</td>
									<td align="right">是否检疫：</td>
									<td align="left">
										<input type="text" size="25" name="quarantine" value="${List.quarantine }" >
									</td>
