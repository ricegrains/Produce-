...
<html>
  ...
  <body bgcolor="#dfe8f4">
		<div style="font-family: inherit">&nbsp; 
			<input style="background-color: #e8f2fe;" border="0" type="text" disabled="disabled" value="质量安全检测>>添加检测计划">
		</div>
							...
							<td bgcolor="#e3f1fe" valign="middle" align="center" width="100%">
								<fieldset style="width: 90%;"  >
									...
									<table border="1" width="90%" align="center">
										<tr>
											<input type="hidden" name="testplanid" />
								        ...
								        <tr>
											...
											<td>
								  			   <input type="text" name="schedulefinishdate" >
								  			</td>
								      </tr>
								      <tr>
										  ...
										  <td align="left">
											  <input type="text" name="planquantity">
										  </td>
									</tr>
									<tr>
										  <td align="right"> 已完成次数 </td>
										  <td align="left">
											  <input type="text" name="finishedquantity">
										  </td>
										  <td align="right"> 合格数 </td>
										  <td align="left">
											  <input type="text" name="passamount">
										  </td>
									</tr>
									<tr>
										<td align="right"> 合格百分比 </td>
										 <td align="left">
											<input type="text" name="passppercentage">
										</td>
