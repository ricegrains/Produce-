...
<html>
  <head> 
    <title>My JSP 'addInputUserInfor.jsp' starting page</title>
  </head>
  
  <body>
    <form action="../addInputUserInforServlet" method="post" name="form">
   <table border="0" width="108%" height="100%">
     ...
     <tr>
        <td>
           <h1><center>投入品使用(添加记录)</center></h1>
        </td>
     </tr>
     ...
     <tr align="center">
        <td colspan="2">
          ...
          <input type="button" value="查看" name="look" style="height:30px;width:200px;font-size:20px;color=red"/>
           &nbsp; &nbsp; &nbsp;&nbsp;
          <a href="../selectAllInputUseServelt">查看历史纪录</a>
        </td>
     </tr>
   </table>
   </form>
