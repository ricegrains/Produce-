...
<html>
  <head>
    <title>My JSP 'selectAllReports.jsp' starting page</title>
  </head>
  
  <body>
    <form action="selectAllReportsServlet" method="post" name="frm">
	   <table width="100%" height="100%" border="1" align="center">
	   <tr height="20%" bgcolor="66FFCC">
	      <td colspan="10">
	         <h1><center>上传报表的历史记录</center></h1>
	      </td>
      </tr>	
	   ...
	   <c:forEach items="${reports_List}" var="str">
			<tr align="center">
				...
				<td>
				   <a href="">修改</a>
				   <a href="deleteReportsServlet?ReportID=${str.reportID }">删除</a>
				</td>
			</tr>
		</c:forEach>
		<tr bgcolor="yellow" align="center">
	        <td colspan="10">
	           <a href="selectAllReportsServlet?currentlyPageNum=1">首页</a>
	           <a href="selectAllReportsServlet?currentlyPageNum=${currentlyPageNum-1 }">上一页</a>
	           <a href="selectAllReportsServlet?currentlyPageNum=${currentlyPageNum+1 }">下一页</a>
	           <a href="selectAllReportsServlet?currentlyPageNum=${totalPage }">尾页</a>
