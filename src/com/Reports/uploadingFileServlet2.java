...
public class uploadingFileServlet2  extends HttpServlet
{
			...
			while(it.hasNext()){
				...
				if(fileItem.isFormField()){   
					...
					if(fileItem.getName()!=null && fileItem.getSize()!=0){
						...
						url = request.getRealPath("UploadFile2")+"/" + fullFile.getName();
