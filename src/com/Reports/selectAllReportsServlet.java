...
public class selectAllReportsServlet extends HttpServlet
{
    @Override
    ...
    List reports_List=ReportsDAO.findAllReports(currentlyPageNum);
    ...
    req.getRequestDispatcher("Sell/selectAllReports.jsp").forward(req, resp);
    }
}
